...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const storyIcons = {
        cow: `<svg fill=#333 aria-hidden="true" focusable="false" class="icon" viewBox="2 -5 600 640" width="-em" height="4em" fill="#333" xmlns="http://www.w3.org/2000/svg">
        ...
        users: `<svg fill=#333 aria-hidden="true" focusable="false" class="icon" viewBox="2 -5 600 640" width="-em" height="4em" fill="#333" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
        ...
        'dollar-sign': `<svg fill=#333 aria-hidden="true" focusable="false" class="icon" viewBox="2 -5 600 640" width="-em" height="4em" fill="#333" xmlns="http://www.w3.org/2000/svg">
        ...
        leaf: `<svg fill=#333 aria-hidden="true" focusable="false" class="icon" viewBox="2 -5 600 640" width="em" height="4em" fill="#333" xmlns="http://www.w3.org/2000/svg">
    ...
    const mediaIcons = {
        video: `<svg xmlns="http://www.w3.org/2000/svg" fill=#333 viewBox="0 0 640 600" height="2em" width="2em" fill="#333"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M96 64c-35.3 0-64 28.7-64 64l0 256c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-256c0-35.3-28.7-64-64-64L96 64zM464 336l73.5 58.8c4.2 3.4 9.4 5.2 14.8 5.2 13.1 0 23.7-10.6 23.7-23.7l0-240.6c0-13.1-10.6-23.7-23.7-23.7-5.4 0-10.6 1.8-14.8 5.2L464 176 464 336z"/></svg>`,
        camera: `<svg xmlns="http://www.w3.org/2000/svg" fill=#333 viewBox="0 0 640 640" height="3em" width="3em" fill="#333"><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M193.1 32c-18.7 0-36.2 9.4-46.6 24.9L120.5 96 64 96C28.7 96 0 124.7 0 160L0 416c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-256c0-35.3-28.7-64-64-64l-56.5 0-26-39.1C355.1 41.4 337.6 32 318.9 32L193.1 32zm-6.7 51.6c1.5-2.2 4-3.6 6.7-3.6l125.7 0c2.7 0 5.2 1.3 6.7 3.6l33.2 49.8c4.5 6.7 11.9 10.7 20 10.7l69.3 0c8.8 0 16 7.2 16 16l0 256c0 8.8-7.2 16-16 16L64 432c-8.8 0-16-7.2-16-16l0-256c0-8.8 7.2-16 16-16l69.3 0c8 0 15.5-4 20-10.7l33.2-49.8zM256 384a112 112 0 1 0 0-224 112 112 0 1 0 0 224zM192 272a64 64 0 1 1 128 0 64 64 0 1 1 -128 0z"/></svg>`,
        book: `<svg xmlns="http://www.w3.org/2000/svg" fill=#333 viewBox="0 0 640 640" height="3em" width="3em" fill="#333><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M232 144C218.7 144 208 154.7 208 168L208 472C208 480.4 206.6 488.5 203.9 496L504 496C517.3 496 528 485.3 528 472L528 168C528 154.7 517.3 144 504 144L232 144zM136 544C96.2 544 64 511.8 64 472L64 176C64 162.7 74.7 152 88 152C101.3 152 112 162.7 112 176L112 472C112 485.3 122.7 496 136 496C149.3 496 160 485.3 160 472L160 168C160 128.2 192.2 96 232 96L504 96C543.8 96 576 128.2 576 168L576 472C576 511.8 543.8 544 504 544L136 544zM256 216C256 202.7 266.7 192 280 192L328 192C341.3 192 352 202.7 352 216L352 264C352 277.3 341.3 288 328 288L280 288C266.7 288 256 277.3 256 264L256 216zM408 240L456 240C469.3 240 480 250.7 480 264C480 277.3 469.3 288 456 288L408 288C394.7 288 384 277.3 384 264C384 250.7 394.7 240 408 240zM280 320L456 320C469.3 320 480 330.7 480 344C480 357.3 469.3 368 456 368L280 368C266.7 368 256 357.3 256 344C256 330.7 266.7 320 280 320zM280 400L456 400C469.3 400 480 410.7 480 424C480 437.3 469.3 448 456 448L280 448C266.7 448 256 437.3 256 424C256 410.7 266.7 400 280 400z"/></svg>`,
        users: `<svg xmlns="http://www.w3.org/2000/svg" fill=#333 viewBox="0 0 640 640" height="3em" width="3em" fill="#333><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M64 128a112 112 0 1 1 224 0 112 112 0 1 1 -224 0zM0 464c0-97.2 78.8-176 176-176s176 78.8 176 176l0 6c0 23.2-18.8 42-42 42L42 512c-23.2 0-42-18.8-42-42l0-6zM432 64a96 96 0 1 1 0 192 96 96 0 1 1 0-192zm0 240c79.5 0 144 64.5 144 144l0 22.4c0 23-18.6 41.6-41.6 41.6l-144.8 0c6.6-12.5 10.4-26.8 10.4-42l0-6c0-51.5-17.4-98.9-46.5-136.7 22.6-14.7 49.6-23.3 78.5-23.3z"/></svg>`,
        chart: `📊`,
        presentation: `<svg xmlns="http://www.w3.org/2000/svg" fill=#333 viewBox="0 0 384 512" height="3em" width="3em" fill="#333><!--!Font Awesome Free v7.1.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.--><path d="M64 48l112 0 0 88c0 39.8 32.2 72 72 72l88 0 0 240c0 8.8-7.2 16-16 16L64 464c-8.8 0-16-7.2-16-16L48 64c0-8.8 7.2-16 16-16zM224 67.9l92.1 92.1-68.1 0c-13.3 0-24-10.7-24-24l0-68.1zM64 0C28.7 0 0 28.7 0 64L0 448c0 35.3 28.7 64 64 64l256 0c35.3 0 64-28.7 64-64l0-261.5c0-17-6.7-33.3-18.7-45.3L242.7 18.7C230.7 6.7 214.5 0 197.5 0L64 0zM80 288l0 96c0 17.7 14.3 32 32 32l96 0c17.7 0 32-14.3 32-32l0-24 35 35c3.2 3.2 7.5 5 12 5 9.4 0 17-7.6 17-17l0-94.1c0-9.4-7.6-17-17-17-4.5 0-8.8 1.8-12 5l-35 35 0-24c0-17.7-14.3-32-32-32l-96 0c-17.7 0-32 14.3-32 32z"/></svg>`
    };
    ...
    if (document.getElementById('press-content')) {
        fetch('news-data.json')
            ...
            .then(data => {
                ...
                factSheetSection.className = 'press-section';
                factSheetSection.innerHTML = `
                    <h4>${pressKit.factSheet.title}</h4>
                    <p>${pressKit.factSheet.description}</p>
                    <ul class="fact-list">
                        ${pressKit.factSheet.facts.map(fact => `<li>${fact}</li>`).join('')}
                    </ul>
                    <a href="${pressKit.factSheet.link}" class="cta-button primary">${pressKit.factSheet.buttonText}</a>
                `;
                pressContent.appendChild(factSheetSection);
            })
