...
const productsData = {
    ...
    'eco-sav-bags': {
        title: 'EcoSav Bags',
        image: '../images/eco-sav-bag-1.webp',
    ...
    'maziwaplus-prechiller-300': {
        ...
        image: '../images/m-pre-chiller.webp',
    ...
    'maziwaplus-prechiller-pro': {
        ...
        image: '../images/pre-chillers-pro.webp',
    ...
    'eco-sav-pasteurizer': {
        ...
        image: '../images/pasturerizer.webp',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (document.getElementById('latest-updates-grid')) {
        fetch('assets/data/impact-data.json')
